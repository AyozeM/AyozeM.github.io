...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__formulario_mainFormulario__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__formulario_ciclos__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__formulario_paises__ = __webpack_require__(7);
...
window.addEventListener("load",()=>{
    ...
    document.querySelector("#movilidad").addEventListener("change",()=>{
        if(document.querySelector('input[type="checkbox"]:checked') == null){
            ...
            Object(__WEBPACK_IMPORTED_MODULE_3__formulario_paises__["a" /* filtraPaisesCiclos */])();
        }
    },false);
},false);
...
const creaToggle = () =>{
    document.querySelector('.toggle input[type="checkbox"]').addEventListener("change",e=>{
        ...
        escribeHtml();
        e.currentTarget.checked?Object(__WEBPACK_IMPORTED_MODULE_2__formulario_ciclos__["a" /* escribePaises */])():Object(__WEBPACK_IMPORTED_MODULE_3__formulario_paises__["a" /* filtraPaisesCiclos */])();
    });
}
const escribeHtml = () =>{
...
/* unused harmony export limiparMapa */
